...
//   final AutoDisposeAsyncNotifierProvider<GenericListNotifier<T>, List<T>>
//   provider;
//   final AutoDisposeAsyncNotifierProvider<GenericActionNotifier<T>, void>
//   actionProvider;
...
//
//   @override
//   ConsumerState createState() => _GenericListScreenState<T>();
// }
//
...
//     final dataAsync = ref.watch(widget.provider);
//     final notifier = ref.read(widget.provider.notifier);
//
//     return Scaffold(
...
//           context,
//           MaterialPageRoute(builder: (_) => widget.config.addScreenBuilder!()),
//         ),
...
//                         final msg = await ref
//                             .read(widget.actionProvider.notifier)
//                             .deleteData(id);
//
...
//                           widget.config.onTap!(context, item);
//                         }
//                       },
